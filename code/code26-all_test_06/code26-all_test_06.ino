...
String ssidHome = "UPC0520860";
String passwordHome = "Ae8kdjbmaerx";

//------variables------
//menu
const int NUM_ITEMS = 8, MAX_ITEM_LENGTH = 20;
...
long t_s1, t_s2;
//wifi password setup
String passwordOffgrid, ssidOffgrid, password, ssid, whichWiFi;
int letterIndex = 0, changePorS = 0, lenText;
bool waitWIFIsettings = true, homeWiFi = true, homeWiFibutton = true;
...
void setup() {
  ...
  if(first == 1){
    ...
    otsisName = preferences.getString("OtsisName");
    whichWiFi = preferences.getString("whichWiFi");
    ...
    nameChoosen = preferences.getBool("nameChoosen");
    homeWiFi = preferences.getBool("homeWiFi");
  }
...
void core1( void * pvParameters ){
  for(;;){
    ...
    //********************PASSWORD SETTINGS********************
    while(current_screen == 11) wifiMainSettings();

    //********************PASSWORD SETTINGS********************
    while(current_screen == 15) wifiSettings();

    //********************DEV TOOLS********************
    while(current_screen == 8) devToolsVoid();
    
    //********************CALCULATOR********************
    while(current_screen == 13) calculator();
